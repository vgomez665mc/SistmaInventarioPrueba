...
abstract class BaseIO implements IOInterface, LoggerInterface
{
     ...
     *
     * Contact: Entire website down, database unavailable, etc. This should
     ...
     * Critical conditions.
     *
     * Contact: Application component unavailable, unexpected exception.
     *
     * @param  string $message
     * @param  array  $context
     * @return null
     ...
     *
     * Contact: Use of deprecated APIs, poor use of an API, undesirable things
