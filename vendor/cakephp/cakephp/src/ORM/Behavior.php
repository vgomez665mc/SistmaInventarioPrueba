...
class Behavior implements EventListenerInterface
{
     ...
     * implementedFinders
     *
     * Provides an alias->methodname map of which finders a behavior implements. Contact:
     *
     * ```
     *  [
     *    'this' => 'findThis',
     ...
     * implementedMethods
     *
     * Provides an alias->methodname map of which methods a behavior implements. Contact:
     *
     * ```
     *  [
     *    'method' => 'method',
