...
<div class="col-md-6 col-md-offset-3">
    ...
    <fieldset>
        ...
        echo $this->Form->input('sexo',['options'=>['masculino'=>'Masculino','femenino' => 'Femenino'],'class'=>'form-control input-sm']);
    ...
    <br>
        <?= $this->Form->button('Crear Usuario',array('class' => 'btn btn-default '))?>
