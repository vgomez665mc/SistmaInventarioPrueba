...
<div class="col-md-6 col-md-offset-3">
    ...
    <fieldset>
        <?php
        echo $this->Form->control('cod_ing',array('label'=>'Codigo de ingreso','value'=>''.substr($current_user['nombre'],0,1).$incomeEquipment->id,'class'=>'form-control input-sm'));
    ...
    <div class="col-md-12 text-center">
        <br>
        <?= $this->Form->button('Editar Ingreso',array('class' => 'btn btn-default '))?>
